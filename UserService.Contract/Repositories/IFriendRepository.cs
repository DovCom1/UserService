...
public interface IFriendRepository
{
    ...
    public Task<bool> ExistsAcceptedFriendAsync(Guid userId, Guid friendId, CancellationToken cancellationToken = default);
    public Task<bool> ExistsAsync(Guid userId, Guid friendId, CancellationToken cancellationToken = default);
