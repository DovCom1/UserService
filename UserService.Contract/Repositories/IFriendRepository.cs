...
public interface IFriendRepository
{
    ...
    public Task<bool> IsAcceptedAsync(Guid userId, Guid friendId, CancellationToken ct = default);
    public Task<bool> IsPendingOrAccepted(Guid userId, Guid friendId, CancellationToken ct = default);
