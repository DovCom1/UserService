...
public interface IFriendManager
{
    ...
    public Task<bool> ExistsAcceptedFriendAsync(Guid userId, Guid friendId, CancellationToken ct);
    public Task<bool> ExistsAsync(Guid userId, Guid friendId, CancellationToken ct);
